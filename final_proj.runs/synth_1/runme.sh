...
HD_PWD='U:/Desktop/ECE 437 Labs/final_proj/final_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finaltoplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finaltoplevel.tcl
