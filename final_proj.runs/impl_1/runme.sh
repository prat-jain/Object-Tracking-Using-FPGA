...
HD_PWD='U:/Desktop/ECE 437 Labs/final_proj/final_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log finaltoplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source finaltoplevel.tcl -notrace
